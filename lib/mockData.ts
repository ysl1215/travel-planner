...
export const DEMO_INPUT: TripPlannerInput = {
  ...
  travelPriorities: "We want authentic local food experiences and walkable historic neighbourhoods — not tourist traps. Prefer slow mornings and long dinners over packed schedules.",
};
